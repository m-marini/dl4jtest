 ...
 *
 */
class SingleFileTimeSeriesDataReaderTest {
	...
	private static final String FILE = "src/test/resources/datatest/sample_%d.csv";
	private static final int MIN_FILE_IDX = 0;
	private static final int MAX_FILE_IDX = 9;
	private static final int NUM_SAMPLES = MAX_FILE_IDX - MIN_FILE_IDX + 1;

	private SingleFileTimeSeriesDataReader reader;
	...
	@BeforeEach
	void setup() {
		reader = new SingleFileTimeSeriesDataReader(file(), MIN_FILE_IDX, MAX_FILE_IDX, NUM_INPUTS_COLUMN, NUM_LABELS,
				MINI_BATCH_SIZE, REGRESSION);
	}
